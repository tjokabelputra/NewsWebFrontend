...
function LatestNewsSection({newsItems, onToggleBookmark, isLiked }){
    ...
    return(
        <div className="my-16 max-[1281px]:my-12 max-[1025px]:my-10 max-[768px]:my-8">
            <h2 className="text-5xl font-bold max-[1281px]:text-4xl max-[1025px]:text-3xl max-[768px]:text-2xl">Latest News</h2>
